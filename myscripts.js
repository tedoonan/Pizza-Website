...
var traditional_pizza_names = ['Meat Lovers', 'Supreme Vegetarian', 'Wedge', 'Double Bacon', 'Meat and Cheese', 'BBQ Bacon', 'Italian', 'Triple Cheese', 'Left Beef']
...
function displayMenu(array, pizza_type) {
...
function displayOrder() {
  ...
  //Hide place order button if order is empty
  ...
  //Change height of order box to match size of order
...
function removePizza(name) {
  if (name in current_order_names) {
    ...
    alert("cant remove pizza which isn't in current order");
  }
}
...
$(document).ready(function(){
  ...
  displayMenu(value_pizza_names, 'value_pizza_type');
  displayMenu(traditional_pizza_names, 'traditional_pizza_type');
  displayMenu(gourmet_pizza_names, 'gourmet_pizza_type');
